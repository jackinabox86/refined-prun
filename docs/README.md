...
- **Architecture / infra:** `docs/architecture.md`. Build system, release workflows, source layout, dependency layers, infrastructure internals.
- **Concurrent agent work:** `docs/agent-worktrees.md`. Dedicated worktrees, single-writer ownership, handoffs, recovery, and cleanup safety.
