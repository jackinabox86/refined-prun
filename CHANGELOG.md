...
- `XIT BURNACT`: Remembers the CX buy exchange chosen for a base and defaults that exchange (and MTRA from, when the CX warehouse exists) on the next open. Bases that have never had a selection get no invented default.
